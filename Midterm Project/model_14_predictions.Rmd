...
```{r}
terms <- terms[terms != "Gene_body_hypermethylation_in_cancer"]
terms <- terms[terms != "BioGRID_betweenness"]
terms <- terms[terms != "CNA_deletion"]
terms <- terms[terms != "Super_Enhancer_percentage"]
