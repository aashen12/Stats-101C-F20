...
good_predictors <- c("Missense_Entropy", "S50_score_replication_timing")
potential_predictors <- c("Recurrent_missense_fraction", "Inframe_indel_fraction", "Lost_start_and_stop_fraction",
                          "Exon_Cons", "VEST_score",
                          "Cell_proliferation_rate_CRISPR_KD",
                          "Broad_H3K4me2_percentage", "Broad_H3K27me3_percentage",
                          "Broad_H3K9me3_percentage", "Broad_H3K9ac_percentage", "Broad_H3K9me2_percentage", 
                          "Broad_H4K20me1_percentage", "Polyphen2", "intolerant_pNull", "MGAentropy",
                          "BioGRID_log_degree", "N_Missense", "ncGERP", "intolerant_pRec")
...
```{r}
for(i in length(lda_list)){
  summary(lda_list[[i]])
}

for(i in length(lda_list)){
  summary(logistic_list[[i]])
}
```

```{r}
for (i in 18:length(lda_list)){
