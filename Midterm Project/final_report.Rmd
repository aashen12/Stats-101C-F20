...
Our candidate model's WCA for the training data was `r round(0.78242421, 3)`, which resulted in a WCA of `r round(0.82298, 3)` on the public leader board. We selected a threshold of **ASK ETHAN**...

**Mention Candidate LDA models and which ones were the best. Ask Ethan.**

**Spend good amount of time describing why our model works/doesn't work--should be focus of report**
