...
Our candidate model's WCA for the training data was `r round(0.8100, 3)`, which resulted in a WCA of `r round(0.85248, 3)` on the public leader board. 
...
**Discuss graphics for both models. Ethan include graphics**
