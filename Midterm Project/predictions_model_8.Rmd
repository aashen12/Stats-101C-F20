...
```{r}
final_terms
vars <- training %>% select(Broad_H3K79me2_percentage, Broad_H3K9ac_percentage, Broad_H3K36me3_percentage, FamilyMemberCount, intolerant_pNull, Gene_expression_Z_score, BioGRID_log_degree, S50_score_replication_timing, Polyphen2, VEST_score, Missense_Entropy, Frameshift_indel_fraction, class) # these are just the predictors it liked
...
csv_file <- data.frame("id" = tests$id,
                       "class" = preds)
write.csv(csv_file, "modelpredictions8.csv", row.names = FALSE)
